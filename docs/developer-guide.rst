...
There are nine POST end points in the Model Runner - /{operation}, /transformCSV, /transformCSVDefault, /getBinary, /getBinaryDefault, /transformJSON, /transformJSONDefault, /getBinaryJSON and /getBinaryJSONDefault; and three PUT end points - /model, /proto, and /model/configuration.
