...
There are five POST end points in the Model Runner - /{operation}, /transformCSV, /transformCSVDefault, /getBinary and /getBinaryDefault; and three PUT end points - /model, /proto, and /model/configuration.
